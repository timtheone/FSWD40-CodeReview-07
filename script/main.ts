class Locations {
    constructor (public title:string, public city: string, public address: string, public zipCode: number, public img:string, public createdDate: Date){};
    render(){
...
class Restaurants extends Locations {
    ...
    constructor (title:string, city: string, address: string, zipCode: number, img: string, createdDate: Date, public telNumber: string, public type: string,
...
class Events extends Locations {
    constructor (title:string, city: string, address: string, zipCode: number, img: string, createdDate: Date, public eventDate: string,
                public eventTime: string, public ticketPrice: number){
                    super(title, city, address, zipCode, img, createdDate);
...
let items: any[] = [church, zoo, lemon, sixta, kris, lenny];

function sortByDateAsc(array: any[], key: any) {
    return array.slice().sort(function(a, b) {
        var x = new Date(a[key]).getTime(); var y = new Date(b[key]).getTime();
        return x - y;
    });
};
function sortByDateDesc(array: any[], key: any) {
    return array.slice().sort(function(a, b) {
        var x = new Date(a[key]).getTime(); var y = new Date(b[key]).getTime();
        return y - x;
    });
